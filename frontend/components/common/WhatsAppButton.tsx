...
export default function WhatsAppButton() {
  ...
  const whatsappMsg = encodeURIComponent(
    `Hi ${BRAND.name}! I'd like to place an order 🍽️`
  );
    ...
    <div className="fixed bottom-20 right-4 z-50 lg:bottom-6 lg:right-6">
      <AnimatePresence>
        {isHovered && (
          ...
          >
            <div className="bg-white rounded-lg shadow-elevated px-3 py-2 text-sm font-medium text-forest">
      ...
      <motion.a
        ...
        className="flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-elevated hover:shadow-modal transition-shadow"
